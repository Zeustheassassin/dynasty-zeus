...
// ── Props ──────────────────────────────────────────────────────────────────
type DataHubTabId = "RANKINGS" | "VALUE_TRENDS" | "PROJECTIONS" | "PICK_VALUES" | "LEAGUEMATES" | "DEPTH_CHARTS";
    ...
    <>
      ...
      <div className="flex justify-center border-b border-gray-800 mb-6 overflow-x-auto">
        <div className="flex justify-center gap-6 text-center">
          {(["RANKINGS", "VALUE_TRENDS", "PROJECTIONS", "PICK_VALUES", "LEAGUEMATES", "DEPTH_CHARTS"] as const).map((tab) => (
            <button
              key={tab}
