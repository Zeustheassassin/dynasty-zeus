...
function makeLeagueOverviewData(): Record<string, LeagueOverviewEntry> {
  ...
  return {
    L1: {
      league,
      rosters: [
        { roster_id: 1, owner_id: "u1", players: ["p1"], settings: { wins: 5, losses: 5, fpts: 1200, ppts: 1300 } },
        { roster_id: 2, owner_id: "u2", players: ["p2"], settings: { wins: 5, losses: 5, fpts: 900, ppts: 1000 } },
      ],
      picks: [],
      userMap: {},
