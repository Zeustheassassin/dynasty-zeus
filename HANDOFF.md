...
| `LEAGUES` | League Hub | yes | Per-league standings, rosters, season simulator, league-mate intel, notes, activity, power rankings, team tools — age curve/positional radar/needs summary for any roster ([components/LeagueHub/](components/LeagueHub/)). |
