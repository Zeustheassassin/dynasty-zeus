...
20. [Test suite scope (534 tests, 23 files)](#20-test-suite-scope-534-tests-23-files)
...
## 20. Test suite scope (534 tests, 23 files)
...
7. **In PowerShell** (not Git Bash): `npm run test` → confirm **534 tests pass** across 23 files. If you see "0 tests," you're in the wrong shell.
