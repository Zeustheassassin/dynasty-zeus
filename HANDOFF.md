...
20. [Test suite scope (541 tests, 24 files)](#20-test-suite-scope-541-tests-24-files)
...
## 20. Test suite scope (541 tests, 24 files)
...
7. **In PowerShell** (not Git Bash): `npm run test` → confirm **541 tests pass** across 24 files. If you see "0 tests," you're in the wrong shell.
