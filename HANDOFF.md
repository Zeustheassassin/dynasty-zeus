...
20. [Test suite scope (563 tests, 27 files)](#20-test-suite-scope-563-tests-27-files)
...
## 20. Test suite scope (563 tests, 27 files)
...
7. **In PowerShell** (not Git Bash): `npm run test` → confirm **563 tests pass** across 27 files. If you see "0 tests," you're in the wrong shell.
