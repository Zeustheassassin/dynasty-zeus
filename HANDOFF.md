...
20. [Test suite scope (602 tests, 30 files)](#20-test-suite-scope-602-tests-30-files)
...
## 20. Test suite scope (602 tests, 30 files)
...
7. **In PowerShell** (not Git Bash): `npm run test` → confirm **602 tests pass** across 30 files. If you see "0 tests," you're in the wrong shell.
